...
from keras.layers import Input, Lambda, Activation, Conv2D, MaxPooling2D, ZeroPadding2D, Reshape, Concatenate, Conv2DTranspose
...
def ssd_300(image_size,
    ...
    base_model = ResNet50(include_top=False, weights='imagenet', input_tensor=x1, input_shape=(300, 300, 3))
    model2 = base_model.get_layer('activation_13').output
    conv4_3 =  Conv2DTranspose(512, (2, 2), name='Change_1', activation='relu', padding='valid')(model2)

    fc7 = base_model.get_layer('activation_25').output
    conv6_2 =  base_model.get_layer('activation_41').output
    # -----------------------------------------------------
